...
const steps = [
  ...
  },
  {
    step: 2,
    title: "Configure",
    description: "Run the 5-step setup wizard: OpenCode detection, bot token, user ID, MCP tools, and voice.",
    code: "relay onboard",
  },
  {
    step: 3,
