...
Show all scheduled jobs with action buttons: enable/disable, run now, and delete.
...
Use `/cron` and tap **Add Job** to build a schedule step by step. The picker walks through type, time, and days, then shows a ready-to-copy `/cron add` command.
