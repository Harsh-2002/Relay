...
| `relay onboard` | Interactive configuration wizard (5-step flow) |
...
When enabled, Relay auto-injects the corresponding MCP server configs into OpenCode's configuration.
