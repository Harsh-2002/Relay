...
The bot loads `SKILL.md` from the `.relay/` directory if it exists, otherwise uses a built-in default. The file is watched and reloaded automatically on change. See [Features](/docs/features#system-prompt) for details.
