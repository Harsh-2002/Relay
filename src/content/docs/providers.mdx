---
title: "Providers"
description: "AI providers, speech-to-text, and translation setup"
order: 3
---
...
Relay uses [OpenCode](https://github.com/opencode-ai/opencode) as its AI backend. OpenCode supports 75+ AI providers through a single unified interface. The OpenCode SDK is bundled — no extra installation needed.
