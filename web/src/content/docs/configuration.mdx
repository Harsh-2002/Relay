...
Each provider has its own set of required and optional variables. See [Providers](/docs/providers) for detailed setup.
...
See [Features > System Prompt](/docs/features#system-prompt) for details on customizing the prompt.
